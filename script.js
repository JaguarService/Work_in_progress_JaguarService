...
function pagarClicked(event) {
  ...
  /////////////////////////////////////LO NUEVO
  const tabs= document.querySelectorAll('.dropact');
...
/*const aseoLimpiezaLi = document.querySelector('li.dropact:nth-child(2)');
aseoLimpiezaLi.addEventListener('click', () => {
  const items = document.querySelectorAll('.item[data-category="ase&limp"]');
  items.forEach((item) => {
...
/*// Selecciona todos los elementos <li> con la clase "dropact activedrop"
const dropactElements = document.querySelectorAll('.dropact.activedrop');

// Agrega un evento click a cada elemento
dropactElements.forEach((element) => {
  element.addEventListener('click', () => {
    // Selecciona el elemento <li> con la clase "tab-category" y el atributo data-name="todos"
    const tabCategoryElement = document.querySelector('.tab-category[data-name="todos"]');
    
    // Agrega la clase "actives" al elemento
    tabCategoryElement.classList.add('actives');
  });
});*/
...
/*// Selecciona todos los elementos <li> con la clase "dropact activedrop"
const dropactElements = document.querySelectorAll('.dropact');

// Agrega un evento click a cada elemento
dropactElements.forEach((element) => {
  element.addEventListener('click', () => {
    // Elimina la clase "actives" de todos los elementos <li> que la tengan
    document.querySelectorAll('.actives').forEach((el) => {
      el.classList.remove('actives');
    });
    
    // Agrega la clase "actives" al elemento seleccionado
...
// Selecciona todos los elementos <li> con la clase "dropact"
const dropactElements = document.querySelectorAll('.dropact');

// Agrega un evento click a cada elemento
dropactElements.forEach((element) => {
  element.addEventListener('click', () => {
    // Quita la clase "actives" de cualquier filtro que la tenga
    document.querySelectorAll('.actives').forEach((el) => {
      el.classList.remove('actives');
    });
    
    // Agrega la clase "actives" al filtro "Todos"
    const tabCategoryElement = document.querySelector('.tab-category[data-name="todos"]');
    tabCategoryElement.classList.add('actives');
    
    // Cambia de sección
    // Aquí debes agregar el código para cambiar de sección
    // Por ejemplo, si tienes una función que cambia de sección, puedes llamarla aquí
    // changeSection(element.dataset.section);
